...
//and a constructor. Next, rewrite class CommissionEmployee from Section 9.4.5 as a subclass of Employee. 
...
public class Employee {
	...
	{
		return String.format("Punonjesi eshte %n%s %s%nSSN%s", getFirstName(), getLastName(), getSocialSecurityNumber());
	}
}
